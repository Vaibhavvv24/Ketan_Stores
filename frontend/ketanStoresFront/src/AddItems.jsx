...
import MensAddItems from './pages/Mens-Options/MensAddItems';
                            ...
                            >
                                <div className='flex justify-center items-center gap-12'>
                                    <div className='flex justify-left items-center h-[20px]'>
                                        <input type="radio" value="mens" onClick={(e) => {displayMensOptions(e.target.value)}} name="clothing" />
                                        <Typography level='body-sm' className='pl-2'>Mens</Typography>
                                    </div>
                                    <div className='flex justify-left items-center h-[20px]'>
                                        <input type="radio" value="kids" onClick={(e) => displayMensOptions(e.target.value)} name="clothing" />
                                        <Typography level='body-sm' className='pl-2'>Kids</Typography>
                                    </div>
                                </div>
                            </RadioGroup>
                        </div>
